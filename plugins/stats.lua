...
local function run(msg, matches)
  if matches[1]:lower() == 'ssss' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "ssss" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (ssss)",-- Put everything you like :)
		"^[!/](ssss)"-- Put everything you like :)
    }, 
  run = run
}
