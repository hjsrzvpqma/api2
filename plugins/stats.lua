...
local function run(msg, matches)
  if matches[1]:lower() == 'sss' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "helper" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (helper)",-- Put everything you like :)
		"^[!/](sss)"-- Put everything you like :)
    }, 
  run = run
}
